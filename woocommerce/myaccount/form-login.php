...
<?php endif; ?>
	...
	<section class="login-section" id="login-section">
		<div class="login-section__img">
			<img src="<?php echo get_template_directory_uri(); ?>/src/images/man.jpeg" alt="Man working from home" />
		</div>
		<div class="login-section__form">
			...
			<form class="woocommerce-form woocommerce-form-login login" method="post">
					...
					<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
						<label for="email"><?php esc_html_e( 'EMAIL', 'woocommerce' ); ?></label>
                              <input type="text" class="woocommerce-Input woocommerce-Input--text input-text" name="email" id="email" autocomplete="email" value="<?php echo ( ! empty( $_POST['email'] ) ) ? esc_attr( wp_unslash( $_POST['email'] ) ) : ''; ?>" /><?php // @codingStandardsIgnoreLine ?>
					</p>
					<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
			...
			<span class="register-notice"><?php esc_html_e( 'Not a member yet?', 'woocommerce' ); ?> <a href="#" id="showReg">Register Now</a></span>
		</div>
...
<?php if ( 'yes' === get_option( 'woocommerce_enable_myaccount_registration' ) ) : ?>
	<section class="register-section" id="register-section">
		<div class="register-section__img">
			<img src="<?php echo get_template_directory_uri(); ?>/src/images/woman.jpeg" alt="woman working from home" />
		</div>
		<div class="register-section__form">
			...
			<form method="post" class="woocommerce-form woocommerce-form-register register" <?php do_action( 'woocommerce_register_form_tag' ); ?> >
					...
					<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
						 <label for="reg_email"><?php esc_html_e( 'Password', 'woocommerce' ); ?></label>
					...
					<p>I agree to the Terms & Conditions, Privacy Policy and Cookie Notice.</p>

					<?php do_action( 'woocommerce_register_form_end' ); ?>

			</form>
			   <span class="login-notice"><?php esc_html_e( 'Are you a member?', 'woocommerce' ); ?> <a href="#" id="showLogin">Login Now</a></span>
		</div>
	</section>
<?php endif; ?>
